            ...
            <Container fluid className="flex-row">
                ...
                <Stack direction="vertical" className="align-items-center justify-content-center" style={{gap: '75px'}}>
                    <Row className="justify-content-center align-items-center" style={{gap: '40px'}}>
                        <Col md='8'>
                            <h6 className="display-6 fw-bold fst-italic text-start" style={{color: 'gray'}}>
                                - Sign Language -</h6>
                            <p className="lead text-start">
                                Bahasa isyarat itu cara komunikasi pakai gerakan tangan, ekspresi wajah, dan bahasa
                                tubuh.
                    ...
                    <Row className="justify-content-center align-items-center" style={{gap: '40px'}}>
                        ...
                        <Col md={8}>
                            <h6 className="display-6 fw-bold fst-italic text-end" style={{color: 'gray'}}>
                                - Computer Vision -</h6>
                            <p className="lead text-end">
                                Computer vision itu cabang AI yang bikin komputer bisa "melihat" dan paham gambar atau
                                video,
                                mirip kayak manusia.
